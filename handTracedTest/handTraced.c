...
int main(int argc, char* argv[]){
    ...
    resetViterbiDecoderHard(&viterbiState);
    assert(viterbiState.nodeMetrics[0] == 0);
    assert(viterbiState.nodeMetrics[2] == 5);
    assert(viterbiState.nodeMetrics[1] == 5);
    assert(viterbiState.nodeMetrics[3] == 5);
    assert(viterbiState.traceBack[0] == 0);
    assert(viterbiState.traceBack[2] == 0);
    assert(viterbiState.traceBack[1] == 0);
    assert(viterbiState.traceBack[3] == 0);
    viterbiDecoderHard(&viterbiState, corruptedCoded+0, decoded, 1, false);
    assert(viterbiState.nodeMetrics[0] == 1);
    assert(viterbiState.nodeMetrics[2] == 6);
    assert(viterbiState.nodeMetrics[1] == 1);
    assert(viterbiState.nodeMetrics[3] == 5);
    assert(viterbiState.traceBack[0] == 0b0);
    assert(viterbiState.traceBack[2] == 0b0);
    assert(viterbiState.traceBack[1] == 0b1);
    assert(viterbiState.traceBack[3] == 0b1);
    viterbiDecoderHard(&viterbiState, corruptedCoded+1, decoded, 1, false);
    assert(viterbiState.nodeMetrics[0] == 3);
    assert(viterbiState.nodeMetrics[2] == 1);
    assert(viterbiState.nodeMetrics[1] == 1);
    assert(viterbiState.nodeMetrics[3] == 3);
    assert(viterbiState.traceBack[0] == 0b00);
    assert(viterbiState.traceBack[2] == 0b10);
    assert(viterbiState.traceBack[1] == 0b01);
    assert(viterbiState.traceBack[3] == 0b11);
    viterbiDecoderHard(&viterbiState, corruptedCoded+2, decoded, 1, false);
    assert(viterbiState.nodeMetrics[0] == 1);
    assert(viterbiState.nodeMetrics[2] == 2);
    assert(viterbiState.nodeMetrics[1] == 3);
    assert(viterbiState.nodeMetrics[3] == 2);
    assert(viterbiState.traceBack[0] == 0b100);
    assert(viterbiState.traceBack[2] == 0b010);
    assert(viterbiState.traceBack[1] == 0b101);
    assert(viterbiState.traceBack[3] == 0b011);
    viterbiDecoderHard(&viterbiState, corruptedCoded+3, decoded, 1, false);
    assert(viterbiState.nodeMetrics[0] == 2);
    assert(viterbiState.nodeMetrics[2] == 2);
    assert(viterbiState.nodeMetrics[1] == 2);
    assert(viterbiState.nodeMetrics[3] == 4);
    assert(viterbiState.traceBack[0] == 0b1000);
    assert(viterbiState.traceBack[2] == 0b0110);
    assert(viterbiState.traceBack[1] == 0b1001);
    assert(viterbiState.traceBack[3] == 0b1011);
